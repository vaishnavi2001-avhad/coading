#include "5.h"
//g++ 5.cpp 5helper.cpp -o myexe

DoublyCLL::DoublyCLL() //constructor(to allcate resource and initialize characteristics)
{
    Head = NULL;
    Tail = NULL;
    CountNode = 0;
...
void DoublyCLL::InsertFirst(int iNo)
{
    ...
    if (CountNode == 0)// from digram,or we can write if( Head==NULL && Tail==NULL)
    {
        Head = newn;
        Tail = newn;
    }
